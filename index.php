...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($user) {
        ...
        if (password_verify($_POST["password"], $user["password_hash"])) {
            ...
            // Verificar si hay descarga pendiente
            if (isset($_SESSION['intended_download'])) {
                $download_id = $_SESSION['intended_download'];
                echo "<!-- DEBUG: Redirigiendo a descarga pendiente: " . $download_id . " -->\n";
                header("Location: /Proyecto_final/download_public.php?id=$download_id");
                exit;
            }
            
            echo "<!-- DEBUG: Redirigiendo a /Proyecto_final/app/index.html -->\n";
